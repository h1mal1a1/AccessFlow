...
public interface IConnectionService
{
    ...
    Task<List<ConnectionDto>> GetConnectionsAsync(int page, int pageSize, CancellationToken cancellationToken);
    ...
    Task<List<ConnectionDto>> GetDeletedConnectionsAsync(CancellationToken cancellationToken);
}
